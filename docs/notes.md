...
14 条日志 + **3 条目标**实测日志卡：2560→156.1px、1920→116.1、1600→98.1、1440/1280→67.0
（目标卡 207.2、指标卡恒为 178.7px）。
**这排数完全取决于喂了几行目标**：同样 14 条日志、6 条目标时目标卡涨到 314.8，
日志卡五档**全部**塌到 67.0 —— 67 就是它的下限（标题 45.1 + 列表可见约 22px，其余靠卡内滚动条看）。
两次跑下来五档**页面竖滚全是 0**，右栏自己不滚；原来这里写的"右栏只有 1440/1280 两档竖滚"
今天重量不成立，README 里同源的那句"1440×900 及以下右栏要竖滚"已经删掉。
